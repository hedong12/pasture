...
<%--                             添加表单 --%>
                            <div id="modal1" class="modal">
                                ...
                                <form id="form0" enctype="multipart/form-data">
                                    ...
                                    <label class="addlabel">奖品名称：</label><input class="addinput" type="text"  id="prizeName" placeholder="请输入奖品名称" /><span class="spa spa2"></span><br />
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/prize/prizeList">
                                    <input  name="prizeName" value="${prizeName}" placeholder="请输入奖品名...">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="prize">
                                            <tr>
                                                <td>${prize.prizeName}</td>
                                                <td>
                                                    <img class="pic" height="40" width="60"  title="${prize.prizeName}" src="${pageContext.request.contextPath}/uploaded/${prize.prizeImgUrl}">
                                                </td>
                                                <td>${prize.petsName}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${prize.addTime}" pattern="yyyy-MM-dd" />
                                                </td>
                                                <td>
...
<script>
        ...
        function delFodderById(e) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/prize/delPrizeById",
                data: {"id" : e},
                dataType: "json",
    ...
    function subForm() {
        ...
        if (ph.test($("#showId").val()) && $("#prizeName").val() != "" && $("#petsId").val() != "" && $("#status").val() != "" && $("#filename").val() != "") {
            ...
            formData.append('prizeName',$("#prizeName").val());

                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/fodder/doUpdateFodderById" method="post">
                                        <input type="hidden" name="fodderId" value="${fodder.fodderId}">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">牧场ID</label>
                                            <input type="text" name="showId" id="exampleInputEmail1" class="form-control" value="${fodder.showId}" placeholder="请输入牧场ID..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">饲料名称</label>
                                            <input type="text" name="fodderName" class="form-control" id="exampleInputPassword2" value="${fodder.fodderName}" placeholder="请输出经验奖品名称..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">饲料图片</label>
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${pageContext.request.contextPath}/uploaded/${fodder.fodderImgUrl}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">饲料等级</label>
                                            <input type="text" name="fodderLevel" class="form-control" id="exampleInputPassword5" value="${fodder.fodderLevel}" placeholder="请输入数量..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword6">饲料经验值</label>
                                            <input type="text" name="fodderExp" class="form-control" id="exampleInputPassword6" value="${fodder.fodderExp}" placeholder="请输入数量..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword7">状态</label>
                                            <select id="exampleInputPassword7" name="fodderStatus" class="form-control" >

...
<%--                            <input type="button"  class="modalLink btn btn-success" value="添加饲料">--%>
                        ...
                        <%--                            弹窗遮罩--%>
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="userFodderRecord">
                                            <tr>
                                                <td>${userFodderRecord.username}</td>
                                                <td>${userFodderRecord.userFodderNum}</td>
                                                <td>${userFodderRecord.fodderName}</td>
                                                <td>
                                                    <img class="pic" height="40" width="60"  title="${userFodderRecord.fodderName}" src="${pageContext.request.contextPath}/uploaded/${userFodderRecord.fodderImg}">
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${userFodderRecord.addTime}" pattern="yyyy-MM-dd" />
                                                </td>
                                                <td>
                                                    <c:if test="${userFodderRecord.source == 0}">
                                                       广告
                                                    </c:if>
                                                    <c:if test="${userFodderRecord.source == 1}">
                                                        签到
                                                    </c:if>
                                                </td>
                                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList?pn=1">首页</a></li>
                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            <!--下一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/userFodderRecord/userFodderRecordList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>

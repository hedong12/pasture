                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/expprize/doUpdateExpPrizeById" method="post">
                                        <input type="hidden" name="eId" value="${expPrize.eId}">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">牧场ID</label>
                                            <input type="text" name="showId" id="exampleInputEmail1" class="form-control" value="${expPrize.showId}" placeholder="请输入牧场ID..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">经验奖品名称</label>
                                            <input type="text" name="expPrizeName" class="form-control" id="exampleInputPassword2" value="${expPrize.expPrizeName}" placeholder="请输出经验奖品名称..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword6">饲料名称</label>
                                            <select name="fodderId" class="form-control" id="exampleInputPassword6">
                                                <c:if test="${fodderList != null }">
                                                    <c:forEach var="fodder" items="${fodderList}">
                                                        <option <c:if test="${fodder.fodderId == expPrize.expId }">selected="selected"</c:if>
                                                                value="${fodder.fodderId}">${fodder.fodderName}</option>
                                                    </c:forEach>
                                                </c:if>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${expPrize.expImg}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">数量</label>
                                            <input type="text" name="num" class="form-control" id="exampleInputPassword5" value="${expPrize.num}" placeholder="请输入数量..."/>
                                        </div>

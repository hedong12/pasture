...
<%--                             添加表单 --%>
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/sign/signList">
                                    <input name="signName" value="${signName}" placeholder="请输入签到名">
                                    <input name="expPrizeName" value="${expPrizeName}" placeholder="请输入经验奖品名">
...
<script>
        ...
        //删除
        function delSignById(e) {
            var $this = $(this);
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/sign/delSignById",
                data: {"id" : e},
                dataType: "json",

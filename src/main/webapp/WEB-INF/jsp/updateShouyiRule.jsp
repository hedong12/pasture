                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/shouyiRule/doUpdateShouyiRuleById" method="post">
                                        <input type="hidden" name="srId" value="${shouyiRule.srId}">
                                        <div class="form-group">
                                            <label for="exampleInputPassword43">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword43" value="${shouyiRule.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">收益种类名称</label>
                                            <select id="exampleInputPassword2" name="szId" class="form-control">
                                                <c:forEach items="${shouyiZhongleiList}" var="szType">
                                                    <option value="${szType.szId}" <c:if test="${szType.szId == shouyiRule.szId}">selected </c:if>>${szType.szName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword22">收益种类图片</label>
                                            <img style="width: 100px;" id="exampleInputPassword22" src="${pageContext.request.contextPath}/uploaded/${shouyiRule.szImg}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword3">宠物名称</label>
                                            <select name="petsId" class="form-control" id="exampleInputPassword3">
                                                <c:forEach items="${petsList}" var="pets">
                                                        <option value="${pets.petsId}" <c:if test="${pets.petsId == shouyiRule.petsId}">selected</c:if>>${pets.petsName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">宠物图片</label>
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${pageContext.request.contextPath}/uploaded/${shouyiRule.petsImg}">
                                         </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">规则类型</label>
                                            <select name="ruleType" class="form-control" id="exampleInputPassword5">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword42">数量</label>
                                            <input type="text" name="quantity" class="form-control" id="exampleInputPassword42" value="${shouyiRule.quantity}" placeholder="请输入数量"/>
                                        </div>

...
<%--                             添加表单 --%>
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/fodder/fodderList">
                                    ...
                                    <table class="table">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="fodder">
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="pic" height="40" width="60"  title="${fodder.fodderName}" src="${pageContext.request.contextPath}/uploaded/${fodder.fodderImgUrl}">
                                                </td>
                                                <td>${fodder.fodderLevel}</td>
                                                <td>${fodder.fodderExp}</td>
                                                <td>
                                                    <c:if test="${fodder.fodderStatus == 0}">
                                                        正常
                                                    </c:if>
                                                    <c:if test="${fodder.fodderStatus == 1}">
                                                        禁用
                                                    </c:if>

                                                </td>
                                                <td>
                                                     <a  onclick="delFodderById('${fodder.fodderId}')" href="javascript:;">
                                                         <span class="item-status delivered">删除</span>
                                                     </a>
                                                     <a id="updatePetsById" href="${pageContext.request.contextPath}/fodder/toUpdateFodderById?id=${fodder.fodderId}"><span class="item-status delivered">修改</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody><!--/tbody-->
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/fodder/fodderList?pn=1">首页</a></li>

                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/fodder/fodderList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/fodder/fodderList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            ...
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/fodder/fodderList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/fodder/fodderList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
...
<script>
        ...
        function delFodderById(e) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/fodder/delFodderById",
                data: {"id" : e},
                dataType: "json",

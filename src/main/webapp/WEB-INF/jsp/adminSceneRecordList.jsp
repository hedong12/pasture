                    ...
                    <div class="col-sm-12" style="margin: 0;padding: 0">
                        <div class="box">
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList">
                                    <input style="text-indent: 8;" name="pastureName" value="${pastureName}" placeholder="请输入牧场名">
                                    <input style="text-indent: 8;" name="sceneName" value="${sceneName}" placeholder="请输入场景名">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="AdminSceneRecord">
                                            <tr>
                                                <td>${AdminSceneRecord.adminName}</td>
                                                <td>${AdminSceneRecord.pastureName}</td>
                                                <td>${AdminSceneRecord.sceneName}</td>
                                                <td>
                                                    <img class="pic" height="40" width="60" title="${AdminSceneRecord.sceneName}" src="${pageContext.request.contextPath}/uploaded/${AdminSceneRecord.sceneImg}">
                                                </td>
                                                <td>${AdminSceneRecord.sceneLogoName}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody><!--/tbody-->
                                    </table><!--/.table-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList?pn=1">首页</a></li>
                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            <!--下一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/adminSceneRecord/adminSceneRecordList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>

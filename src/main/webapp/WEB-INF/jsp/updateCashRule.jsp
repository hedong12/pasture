                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/cashRule/doUpdateCashRuleById" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="crId" value="${cashRule.crId}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword1" value="${cashRule.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">兑换规则名称</label>
                                            <input type="text" name="crName" class="form-control" id="exampleInputPassword2" value="${cashRule.crName}" placeholder="请输入兑换规则名称"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">规则图片</label>
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${pageContext.request.contextPath}/uploaded/${cashRule.crImg}">
                                         </div>
                                        <div class="form-group">
                                            <label for="filename">选择新的规则图片</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">兑换规则总数量</label>
                                            <input type="text" name="crNum" class="form-control" id="exampleInputPassword5" value="${cashRule.crNum}" placeholder="请输入兑换规则总数量"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword6">条件数量</label>
                                            <input type="text" name="tiaojianNum" class="form-control" id="exampleInputPassword6" value="${cashRule.tiaojianNum}" placeholder="请输入条件数量"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword7">条件兑换次数</label>
                                            <input type="text" name="peopleNum" class="form-control" id="exampleInputPassword7" value="${cashRule.peopleNum}" placeholder="请输入条件兑换次数"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword7">收益种类</label>
                                            <select name="szId" class="form-control">
                                                <c:forEach items="${shouyiZhongleiList}" var="RType">
                                                    <option  value="${RType.szId}" <c:if test="${RType.szId == cashRule.szId}">selected</c:if>>
                                                    ${RType.szName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>

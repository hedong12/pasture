                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/notice/doUpdateNoticeByNotice" method="post">
                                        <input type="hidden" name="nId" value="${notice.nId}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword6">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword6" value="${notice.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">公告名称</label>
                                            <input type="text" name="noticeName" class="form-control" id="exampleInputPassword2" value="${notice.noticeName}" placeholder="请输入公告名称"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword3">公告内容</label>
                                            <textarea style="resize: none;height: 80px;" name="noticeContent" class="form-control" id="exampleInputPassword3" placeholder="请输入公告内容">${notice.noticeContent}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">排序</label>
                                            <input type="number" name="sort" class="form-control" id="exampleInputPassword4" value="${notice.sort}" placeholder="请输入排序数字"/>
                                        </div>
                                        <div class="form-group">

                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/imgcache/doUpdateImgcacheById" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="imgCacheId" value="${imgCache.imgCacheId}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword1" value="${imgCache.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">图片名称</label>
                                            <input type="text" name="imgCacheName" class="form-control" id="exampleInputPassword2" value="${imgCache.imgCacheName}" placeholder="请输入图片名称"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">宠物图</label>
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${pageContext.request.contextPath}/uploaded/${imgCache.imgCacheUrl}">
                                         </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleInputPassword5" name="imgCacheStatus">

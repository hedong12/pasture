...
<%--                             添加表单 --%>
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/task/taskList">
                                ...
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="task">
                                            <tr>
                                                <td>${task.taskName}</td>
                                                <td title="${task.taskContent}" style="white-space:nowrap;text-overflow:ellipsis;overflow:hidden;">
                                                        ${task.taskContent}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${task.addTime}" pattern="yyyy-MM-dd" />
                                                </td>
                                                <td>
                                                     <a onclick="delTaskById('${task.id}')" href="javascript:;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/task/taskList?pn=1">首页</a></li>
                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/task/taskList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/task/taskList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            <!--下一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/task/taskList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/task/taskList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
...
<script>
        ...
        //删除
        function delTaskById(e) {
            var $this = $(this);
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/task/delTaskById",
                data: {"id" : e},
                dataType: "json",

                    ...
                    <div class="col-sm-12" style="margin: 0;padding: 0">
                        <div class="box">
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/address/addressList">
                                    ...
                                    <table class="table">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="address">
                                            <tr>
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${address.addressAddTime}" pattern="yyyy-MM-dd" />
                                                </td>
                                                <td>
                                                    <a  onclick="delAddressById('${address.addressId}')" href="javascript:;">
                                                        <span class="item-status delivered">删除</span>
                                                    </a>
                                                    <a id="updatePetsById" href="${pageContext.request.contextPath}/address/toUpdateAddressById?id=${address.addressId}"><span class="item-status delivered">修改</span></a>
                                                </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/address/addressList?pn=1">首页</a></li>
                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/address/addressList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/address/addressList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            <!--下一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/address/addressList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/address/addressList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
...
<script>
        ...
        //删除
        function delAddressById(e) {
            var $this = $(this);
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/address/delAddressById",
                data: {"id" : e},
                dataType: "json",

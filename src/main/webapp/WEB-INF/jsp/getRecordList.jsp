                    ...
                    <div class="col-sm-12" style="margin: 0;padding: 0">
                        <div class="box">
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/getRecord/getRecordList">
                                    <input style="text-indent: 8;" name="username" value="${username}" placeholder="请输入用户名">
                                    <input style="text-indent: 8;" name="prizeName" value="${prizeName}" placeholder="请输入奖品名">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="getRecord">
                                            <tr>
                                                <td>${getRecord.username}</td>
                                                <td>${getRecord.address}</td>
                                                <td>${getRecord.phone}</td>
                                                <td>
                                                    <c:if test="${getRecord.status == 0}">
                                                        正常
                                                    </c:if>
                                                    <c:if test="${getRecord.status == 1}">
                                                        禁用
                                                    </c:if>
                                                </td>
                                                <td>
                                                    <img class="pic" height="40" width="60" title="${getRecord.prizeName}" src="${pageContext.request.contextPath}/uploaded/${getRecord.prizeImg}">
                                                </td>
                                                <td>${getRecord.prizeName}</td>
                                                <td>
                                                    <fmt:formatDate value="${getRecord.addTime}" pattern="yyyy-MM-dd" />
                                                </td>

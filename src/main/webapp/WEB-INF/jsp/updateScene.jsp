                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/scene/doUpdateSceneByID" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="sceneId" value="${scene.sceneId}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword2">场景名称</label>
                                            <input type="text" name="sceneName" class="form-control" id="exampleInputPassword2" value="${scene.sceneName}" placeholder="请输入场景名称..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword3">场景标识名称</label>
                                            <input type="text" name="sceneLogoName" class="form-control" id="exampleInputPassword3" value="${scene.sceneLogoName}" placeholder="请输入场景标识名称..."/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">场景图</label>
                                            <img style="width: 100px;" id="exampleInputPassword4" src="${pageContext.request.contextPath}/uploaded/${scene.sceneImgUrl}">
                                         </div>
                                        <div class="form-group">
                                            <label for="filename">选择新的场景图</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sceneStatus" class="form-control" id="exampleInputPassword5">

                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/sign/doUpdateSignById" method="post">
                                        <input type="hidden" name="id" value="${sign.sId}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword6">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword6" value="${sign.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">任务名称</label>
                                            <input type="text" name="signName" class="form-control" id="exampleInputPassword2" value="${sign.signName}" placeholder="请输入任务名称"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">连续签到天数</label>
                                            <input type="text" name="signDay" class="form-control" id="exampleInputPassword4" value="${sign.signDay}" placeholder="请输入规则Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">状态</label>
                                            <select name="status" class="form-control" id="exampleInputPassword5">
                                                <c:if test="${sign.status == 0}">
                                                    <option value="0" selected>正常</option>
                                                    <option value="1">禁用</option>
                                                </c:if>
                                                <c:if test="${sign.status == 1}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="eId" class="form-control" id="exampleInputPassword7">
                                                <c:forEach items="${expPrizeList}" var="expPrize">
                                                    <option value="${expPrize.eId}" <c:if test="${expPrize.eId == sign.expPrizeId}">selected</c:if>>${expPrize.expPrizeName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>

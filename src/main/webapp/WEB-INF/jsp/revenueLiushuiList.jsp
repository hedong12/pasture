                    ...
                    <div class="col-sm-12" style="margin: 0;padding: 0">
                        <div class="box">
                            ...
                            <div style="width: 50%;float: right;text-align: center;">
                                <form method="post" action="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="Rliushui">
                                            <tr>
                                                <td>${Rliushui.username}</td>
                                                <td>${Rliushui.slNum}</td>
                                                <td>${Rliushui.szName}</td>
                                                <td>
                                                    <img class="pic" height="40" width="60" title="${Rliushui.szName}" src="${pageContext.request.contextPath}/uploaded/${Rliushui.szImg}">
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${Rliushui.addTime}" pattern="yyyy-MM-dd" />
                                                </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList?pn=1">首页</a></li>
                                            <!--上一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasPreviousPage}">
                                                    <a href="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                                ...
                                                <c:if test="${page_num != pageInfo.pageNum}">
                                                    <li><a href="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList?pn=${page_num}">${page_num}</a></li>
                                                </c:if>
                                            </c:forEach>
                                            <!--下一页-->
                                            <li>
                                                <c:if test="${pageInfo.hasNextPage}">
                                                    <a href="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList?pn=${pageInfo.pageNum+1}"
                                                       aria-label="Next">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </c:if>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/revenueLiushui/revenueLiushuiList?pn=${pageInfo.pages}">尾页</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>

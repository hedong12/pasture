                        ...
                        <div class="box">
                            ...
                            <div class="item">
                                <div class="item-responsive ">
                                    <form action="${pageContext.request.contextPath}/task/doUpdateTaskById" method="post">
                                        <input type="hidden" name="id" value="${task.id}">

                                        <div class="form-group">
                                            <label for="exampleInputPassword6">牧场Id</label>
                                            <input type="text" name="showId" class="form-control" id="exampleInputPassword6" value="${task.showId}" placeholder="请输入牧场Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword2">任务名称</label>
                                            <input type="text" name="taskName" class="form-control" id="exampleInputPassword2" value="${task.taskName}" placeholder="请输入任务名称"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword3">任务内容</label>
                                            <textarea style="resize: none;height: 80px;" name="taskContent" class="form-control" id="exampleInputPassword3" placeholder="请输入任务内容">${task.taskContent}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">规则Id</label>
                                            <input type="number" name="guizeId" class="form-control" id="exampleInputPassword4" value="${task.guizeId}" placeholder="请输入规则Id"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword5">状态</label>
                                            <select name="status" class="form-control" id="exampleInputPassword5">
                                                ...
                                                <c:if test="${task.status == 1}">
                                                    ...
                                                    <option value="1" selected>未发布</option>
                                                </c:if>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword6">任务类型</label>
                                            <select name="taskType" class="form-control" id="exampleInputPassword7">
                                                <c:if test="${task.taskType == 0}">
                                                    <option value="0" selected>签到</option>
                                                    <option value="1">视频</option>
                                                    <option value="2">转发</option>
                                                    <option value="3">友商</option>
                                                </c:if>
                                                ...
                                                <c:if test="${task.taskType == 2}">
                                                    <option value="0" >签到</option>
                                                    <option value="1" >视频</option>
                                                    <option value="2" selected>转发</option>
                                                    <option value="3">友商</option>
                                                </c:if>
                                                <c:if test="${task.taskType == 3}">
                                                    ...
                                                    <option value="1" >视频</option>
                                                    <option value="2" >转发</option>
                                                    <option value="3" selected>友商</option>
                                                </c:if>
                                            </select>
                                        </div>
